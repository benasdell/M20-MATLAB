%Video URL: https://youtu.be/Wu0uzyAcrFI
...
pCrossover = 0.8;
pMutation = 0.3;
xOpt = geneticAlgorithm(f,d,populationSize,pCrossover,pMutation);
fprintf('The final optimized angles (in radians) are %f, %f, %f, and %f \n',xOpt(1),xOpt(2),xOpt(3),xOpt(4));    